...
$resources += @(Get-ChildItem (Join-Path $PSScriptRoot 'Tidefork\Assets') -Filter '*.png' | Where-Object Name -ne 'model-preview.png' | ForEach-Object { '/resource:'+$_.FullName+',Tony.Tidefork.'+$_.Name })
