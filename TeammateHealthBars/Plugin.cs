...
namespace TonyMods
{
    [BepInPlugin("Tony.TeammateHealthBars", "Tony Ale & Tale Mods", "0.14.0")]
    ...
    public sealed class TeammateHealthBars : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo("Tony Ale & Tale Mods 0.14.0 loaded (health panel + YouTube jukebox + original horse + five-seat Horse 2 + X horse storage + musket scope + chest quick stack + M4A1 rifle).");
