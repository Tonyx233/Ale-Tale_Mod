...
namespace TonyMods
{
    [BepInPlugin("Tony.TeammateHealthBars", "Tony Ale & Tale Mods", "0.11.0")]
    ...
    public sealed class TeammateHealthBars : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo("Tony Ale & Tale Mods 0.11.0 loaded (health panel + YouTube jukebox + original horse + five-seat Horse 2 + X horse storage).");
