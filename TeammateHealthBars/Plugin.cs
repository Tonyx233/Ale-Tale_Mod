...
namespace TonyMods
{
    [BepInPlugin("Tony.TeammateHealthBars", "Tony Ale & Tale Mods", "0.5.6")]
    public sealed class TeammateHealthBars : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo("Tony Ale & Tale Mods 0.5.6 loaded (health panel + YouTube jukebox + two-seat horses).");
